...
<script>
    import Drop from '_c/select/dropdown.vue';
    import {directive as clickOutside} from 'v-click-outside-x';
    import TransferDom from './directives/transfer-dom';
    import { DEFAULT_FORMATS, TYPE_VALUE_RESOLVER_MAP, getDayCountOfMonth, oneOf, findComponentsDownward } from './util';
    ...
    export default {
        ...
        data(){
            ...
            return {
                ...
                isFocused: false,
                focusedDate: new Date(initialValue[0]) || new Date(this.startDate) || new Date(),
                focusedTime: {
