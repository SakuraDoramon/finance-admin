        ...
        <div :class="[prefixCls + '-body']">
            <div :class="[prefixCls + '-content', prefixCls + '-content-left']">
                ...
                <time-spinner
                    ...
                    @on-pick-click="handlePickClick('time')"></time-spinner>
            </div>
    ...
    export default {
        ...
        watch: {
            value (dates) {
                ...
                this.dateStart = new Date(dateStart) || initTimeDate();
                this.dateEnd = new Date(dateEnd) || initTimeDate();
            }
        },
        methods: {
            panelLabelConfig (date) {
                const datePanelLabel = '[yyyy年] [m月]';
                const { labels, separator } = formatDateLabels('zh-CN', datePanelLabel, date || initTimeDate());
