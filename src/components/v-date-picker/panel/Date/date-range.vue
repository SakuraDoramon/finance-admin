        ...
        <div :class="panelBodyClasses">
            <div :class="[prefixCls + '-content', prefixCls + '-content-left']">
                <div :class="[datePrefixCls + '-header']">
                    ...
                    <span
                        ...
                        @click="prevMonth('left')"><Icon type="ios-arrow-back"></Icon></span>
                    <date-panel-label
                    ...
                    <span
                        ...
                        @click="nextMonth('left')"><Icon type="ios-arrow-forward"></Icon></span>
                </div>
                <component
                    :is="leftPickerTable"
                    ref="leftYearTable"
                    ...
                    @on-pick-click="handlePickClick('date')"
                ></component>
            </div>
            <div :class="[prefixCls + '-content', prefixCls + '-content-right']">
                <div :class="[datePrefixCls + '-header']">
                    ...
                    <span
                        v-if="splitPanels && rightPickerTable === 'date-table'"
                        :class="iconBtnCls('prev')"
                        @click="prevMonth('right')"><Icon type="ios-arrow-back"></Icon></span>
                    <date-panel-label
                    ...
                    <span
                        ...
                        :class="iconBtnCls('next')"
                        @click="nextMonth('right')"><Icon type="ios-arrow-forward"></Icon></span>
                </div>
                <component
                    :is="rightPickerTable"
                    ref="rightYearTable"
                    ...
                    @on-pick-click="handlePickClick('date')"></component>
            </div>
            <div :class="[prefixCls + '-content']">
                <time-picker
                    ...
                    @on-pick-click="handlePickClick('time')"
    ...
    export default {
        ...
        data(){
            ...
            return {
                ...
                rightPanelDate: new Date(new Date(leftPanelDate).getFullYear(), new Date(leftPanelDate).getMonth() + 1, 1)
            };
        },
        computed: {
            classes(){
        ...
        methods: {
            ...
            panelLabelConfig (direction) {
                ...
                const { labels, separator } = formatDateLabels('zh-CN', datePanelLabel, date);
