<template>
    <div :class="wrapClasses" :style="styles">
        <div :class="classes" class="clusterize">
            ...
            <div id="scrollArea" class="clusterize-scroll" :class="[prefixCls + '-body']" :style="bodyStyle" ref="body" @scroll="handleBodyScroll"
            ...
            <div
                :class="[prefixCls + '-tip']" :style="bodyStyle" @scroll="handleBodyScroll" id="scrollArea" class="clusterize-scroll"
                v-show="((!!localeNoDataText && (!data || data.length === 0)) || (!!localeNoFilteredDataText && (!rebuildData || rebuildData.length === 0)))">
            ...
            <div :class="[prefixCls + '-fixed']" :style="fixedTableStyle" v-if="isLeftFixed">
                ...
                <div id="scrollArea" class="clusterize-scroll" :class="[prefixCls + '-fixed-body']" :style="fixedBodyStyle" ref="fixedBody" @mousewheel="handleFixedMousewheel" @DOMMouseScroll="handleFixedMousewheel">
                    <table-body
                        fixed="left"
                        :draggable="draggable"
                        :prefix-cls="prefixCls"
            ...
            <div :class="[prefixCls + '-fixed-right']" :style="fixedRightTableStyle" v-if="isRightFixed">
                ...
                <div id="scrollArea" class="clusterize-scroll" :class="[prefixCls + '-fixed-body']" :style="fixedBodyStyle" ref="fixedRightBody" @mousewheel="handleFixedMousewheel" @DOMMouseScroll="handleFixedMousewheel">
                    <table-body
                        fixed="right"
                        :draggable="draggable"
                        :prefix-cls="prefixCls"
    ...
    export default {
        ...
        methods: {
            ...
            handleResizeProxy () {
                ...
                this.handleResize()
                this.$emit('on-resize', this.currentColumn.key)
            },
            handleResize () {
            ...
            makeColumns (cols) {
                ...
                columns.forEach((column, index) => {
                    ...
                    // 统一添加resizable属性
                    if (column.key !== 'action' && column.resizable !== false) {
                      column.resizable = true
                    }
                    // 判断如果有操作列的话且操作列fixed，倒数第二列也不可能改列宽
                    if (columns.findIndex(n => n.key === 'action' && n.fixed) > -1) {
                      if (index === (columns.length - 2)) column.resizable = false
                    }
